...
\newcommand{\experienceSectionSubheading}[6]{
  \vspace{-1pt}
    ...
    % \small{\textit{#3} \hfill \spaceskip  0.55em  \relax\textit{#4}} \\
    \small{\textit{#3} \hfill \textls[55]{\textit{#4}}} \\
    \small{\textit{#5} \hfill \textls[8]{\textit{#6}}} \\
...
\sectionListStart
    \sectionListItem
        ...
        % \textit{Technologies: Android SDK, Evernote and Calendar APIs.}
\sectionListEnd
...
\eduListItemWithDate
{University of Mumbai}{B.E Computer Science, GPA: 4/4 (Aggr. 75\%)}{Sep 2010 - May 2014}
\sectionListEnd

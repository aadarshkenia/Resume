...
\geometry{letterpaper,left=0.3in,right=0.3in,top=0.3in,bottom=0.25in}
...
\sectionListStart
    ...
    \sectionListItem
        Iphone X Availability Checker : Python script to periodically check for iPhone availability and send SMS notifications.
    \sectionListItem
